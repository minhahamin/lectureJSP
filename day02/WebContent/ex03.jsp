...
<body>
	...
	<h1>redirect 와 forward</h1>
	<hr>
	
	<table border="1" cellpadding ="10" cellspacing ="0">
		<tr>
			<td> redirect </td>
			<td> response.sendRedirect(주소)</td>
			<td> 브라우저가 받을 응답에 이동할 주소를 작성한다<br>
				 브라우저는 응답을 받은 후 전달받은 주소로 새로운 요청을 보낸다<br>
				 브라우저가 능동적으로 주소를 변경하기 때문에, 바뀐 주소가 주소창에 드러난다<br>
				 새로운 요청이므로, 기존의 request 에 담긴 parameter / attribute는 사용불가<br>
				 현재 서버 외부의 주소에도 리다이렉트 할 수 있음<br>
			</td>
		</tr>
		<tr>
			<td> forward </td>
	...
	<fieldset>
		...
		<p><input type = "text" name ="url" placholder = "URL">
			<input type = "submit"> </p>
		</form>
	</fieldset>
