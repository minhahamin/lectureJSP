...
<body>
	...
	<h3>내장 객체에 저장된 attribute 에 빠르게 접근하여 값을 출력하는 태그</h3>
	<h3>JSP 내장 스펙이므로, 외부 라이브러리 없이 사용 가능함</h3>
	
	<ul>
		<li> 내장 객체를 명시하지 않아도 순서대로 접근하여 attribute 를 찾아서 출력함</li>
		...
		<li> scope를 지정하여 특정 범위에서만 탐색할 수도 있음</li>
		<li> attribute 의 getter에 접근할 수 있음</li>
		<li> 배열 및 리스트의 경우 indexing 으로 접근할 수 있음</li>
		<li> map 이면 key 로 접근할 수도 있음 </li>
		<li> 문자열은 홑따옴표로 표기함</li>
		<li> 파라미터 및 헤더에 접근할 수 있음 </li>
		<li> 단순한 연산자 처리도 가능하며, 산술연산은 문자열에 적용되지 않음</li>
		<li> ()를 명시하여 메서드 호출도 가능함 </li>
